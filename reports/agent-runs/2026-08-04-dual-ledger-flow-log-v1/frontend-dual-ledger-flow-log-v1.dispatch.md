...
- `reports/agent-runs/2026-08-04-dual-ledger-flow-log-v1/evidence/frontend-dual-ledger-flow-log-v1.handoff.md`（create-only；Bookkeeper 须在路由前执行 `test ! -e` 并把结果记在本节；按 `agents/roles.md` 的 Task Handoff Evidence Contract 创建唯一交接件）
