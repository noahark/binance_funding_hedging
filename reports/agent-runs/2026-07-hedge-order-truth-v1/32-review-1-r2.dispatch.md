...
outputs: reports/agent-runs/2026-07-hedge-order-truth-v1/32-review-1-r2.md
verdict: REWORK (schema-valid; fingerprint matched; 1 P1)
next_dispatch: reports/agent-runs/2026-07-hedge-order-truth-v1/33-fix-review-1-r3.dispatch.md (human operator)
