Identity: task_id: harness-handoff-contract-review-1-kimi-v1; target_role: Reviewer; target_model: kimi; provider: moonshot; status_revision: 4; required_skill: agents/skills/code-reviewer.md
...
The implementation/fix provider is Zhipu GLM; this Kimi/Moonshot review satisfies
the required cross-provider isolation. Review the actual contract, all relevant
evidence and the fixed range, not the summaries alone.

## Allowed Files

- `reports/agent-runs/2026-08-03-harness-task-handoff-evidence-v1/evidence/harness-handoff-contract-review-1-kimi-v1.handoff.md`

This is the sole create-only write. Bookkeeper preflight ran
`test ! -e reports/agent-runs/2026-08-03-harness-task-handoff-evidence-v1/evidence/harness-handoff-contract-review-1-kimi-v1.handoff.md`
...
1. `AGENTS.md`
2. `reports/agent-runs/2026-08-03-harness-task-handoff-evidence-v1/30-kimi-handoff-contract-review-1.dispatch.md`
