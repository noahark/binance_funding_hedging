...
Status: contract v0.16 as-built (status sync 2026-08-08). The wire
...
and the money-moving `POST /api/asset-transfer`); the snapshot/positions GET
routes themselves stay pure reads.
...
are likewise in the amendments at the end of this file.
...
max-withdraw read; this paragraph stays as the original baseline.)
